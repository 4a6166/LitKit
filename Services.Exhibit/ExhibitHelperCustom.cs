...
namespace Tools.Exhibit
{
    ...
    public class ExhibitHelperCustom
    {
        public ExhibitHelperCustom()
        {
        ...
        public string FormatFirstCite(Exhibit exhibit, int Index, Word.Application _app)
        {
            ...
            string IndexStyle = repository.GetFormatting(FormatNodes.IndexStyle);
            int IndexStart = Int32.Parse(repository.GetFormatting(FormatNodes.IndexStart));
            string Number = ApplyNumFormat(IndexStart -1 + Index, IndexStyle);

            string Description = exhibit.Description;
            string Bates = exhibit.BatesNumber;
            string Pincite = string.Empty;
        ...
        public void AddPincite(Word.Selection sel)
        {
            ...
            else
            {
                ...
                string CiteText = FormatFirstCite(exhibit, Index, sel.Application);
